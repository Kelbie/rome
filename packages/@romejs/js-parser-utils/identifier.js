...
exports.keywordRelationalOperator = /^in(stanceof)?$/;
function isES2015ReservedWord(word) {
    return word === 'enum' || word === 'await';
}
exports.isES2015ReservedWord = isES2015ReservedWord;
...
function getFullCharCodeAt(str, offset) {
...
exports.getFullCharCodeAt = getFullCharCodeAt;
