...
class DependencyOrderer {
    ...
    flagCycle(node, dep, imp) {
        ...
        const culprit = String(path.find((value, index) => path[index - 1] === target));
        this.diagnostics.push({
            description: diagnostics_1.descriptions.BUNDLER.DETECTED_CYCLE(imp.local, target, culprit, path),
            location: {
...
exports.default = DependencyOrderer;
