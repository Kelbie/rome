            ...
            for (const bodyNode of node.body) {
                if (bodyNode.type === 'ImportDeclaration') {
                    ...
                    if (seenLoc === undefined) {
                        ...
                        const { suppressed } = path.context.addNodeDiagnostic(bodyNode, diagnostics_1.descriptions.LINT.DUPLICATE_IMPORT_SOURCE(seenLoc), { fixable: true });
                        if (suppressed) {
            ...
            if (shouldFix) {
                ...
                for (let i = 0; i < node.body.length; i++) {
                    ...
                    if (bodyNode.type === 'ImportDeclaration') {
                        ...
                        let { namedSpecifiers, defaultSpecifier, namespaceSpecifier, } = bodyNode;
